...
@api1.representation('application/xml')
...
# 	resp.headers.extend(headers or {})
#
# 	## remove the Response tag from the returned xml file
...
api1.add_resource(Airline.Airlines, '/airlines') #route to select everything from airlines
